...
wget -q -O ~/.local/share/nautilus-python/extensions/code-nautilus.py https://raw.githubusercontent.com/shashanksapre/code-nautilus/codium/code-nautilus.py # changing to self
